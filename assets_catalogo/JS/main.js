...
btnOffert.addEventListener("click", function () {
  const productosOffert = productos.filter(
    (producto) => producto.offert == "Oferta"
  );
...
btnRecomend.addEventListener("click", function () {
  const productosRecomendados = productos.filter(
    (producto) => producto.recomend == "Recomendado"
  );
...
btnRevestimientos.addEventListener("click", function () {
  const productosRevestimientos = productos.filter(
    (producto) => producto.titulo == "Revestimiento"
  );
...
btnAtermicos.addEventListener("click", function () {
  const productosAtermicos = productos.filter(
    (producto) => producto.titulo == "Atermico"
  );
...
const obtenerMasInfo = () => {
  ...
  MasInfo.forEach((btn) =>
    btn.addEventListener("click", function (e) {
      let btnClickeado = productos.find(
        (element) => element.id == e.currentTarget.id
      );
      let productoExtraido = productos.find(
        (producto) => producto == btnClickeado
      );
